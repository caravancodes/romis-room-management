 ...
 */
public class AdminApprovalObject {
    String namaRuang, agenda, namaUser, waktuAwal, waktuAkhir, noTelp, date, note;

    public AdminApprovalObject(String namaRuang, String agenda, String namaUser, String waktuAwal, String waktuAkhir, String noTelp, String date, String note) {
